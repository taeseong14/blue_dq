...
테스트 끝난 기능들.
 ...
 - (7) 학원교류회 (3중랜덤)
 - (8) 전술 대회 (기본: 1회 돌기)
 - (9) 미션 -> 모두 받기 (임무 x, 오전 -> 8개)
 - (12) 사용자 설정
   - (1) 시스템 - 밝기 낮추기
   - (2) 시스템 - 소리 낮추기
   - (3) AP 구매 ~~(-> AP 999 초과 고려)~~
   - (4) 커스텀 일반 상점 구매 (v)
   - (8) 전술대회 커스텀 (v)
   - (9) 하드스테 소탕
...
6. 카페 터치 솔직히 귀찮은데 그냥 노란색 근처는 다 누르게 해야겟음. 히히
...
> 2024-08-31
 ...
 - 기능 타이밍 추가 조정. 두번쯤 더 필요할듯
 - 대체 왜때문에 이리 빡빡하게 해놨었노 존나
...
> 2024-09-03
 ...
 - 학원교류회 트리니티, 밀레니엄 D스테 마참내 클리어.. 랜덤으로 돌려놓음
 - 사용자 설정 - AP 구매 기능(AP_BUY) 완성
 - 사용자 설정 - 하드임무 소탕 기능(TASK__HARD_ON, TASK__HARD_STAGE) 완성
...
> 2024-09-07
 ...
 - [모모톡 매크로](momotalk_auto.bat) 완성. 따로 실행 가능하게 별개의 파일로 만들엇음. 일퀘매크로 옵션에 넣을 예정?
...
> 2024-09-08
 ...
 - 타이밍 조정, ap구매 수정, 하드임무 소탕 최적화
 - 전술대회 커스텀 관련 (TASK__TACTCHAL_TRY, TASK__TACTCHAL_PICK, TASK__TACTCHAL_CLIAM_REWARD) 완성
 - 미션 모두 받기 기능 완성
...
> 2024-09-11
 - 전술대회, 미션 테스트 완료
 - !!(todo) 내일이나 모레 현상수배, 학원교류회 관련 사용자 설정 기능 완성예정
...
> 2024-09-16
 - 버그 수정
 - 시스템 관련 사용자 설정 (_SYSTEM__VOLUME_DOWN / _SYSTEM__BRIGHTNESS_DOWN)
